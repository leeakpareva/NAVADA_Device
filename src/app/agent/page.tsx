...
export default function AgentPage() {
  useEffect(() => {
    ...
    window.location.href = 'https://claude.ai/public/artifacts/d77f2d87-37ab-4964-9a1f-4899183c0065';
  }, []);
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center">
      <div className="text-center">
        ...
        <a
          href="https://claude.ai/public/artifacts/d77f2d87-37ab-4964-9a1f-4899183c0065"
